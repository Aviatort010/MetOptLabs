...
namespace MathUtils
{
    ...
    public struct TemplatePair<T, K> : IEquatable<TemplatePair<T, K>> where T : IEquatable<T> where K : IEquatable<K>
    {
        ...
        public bool Equals(TemplatePair<T, K> other)
        {
    ...
    public static class VectorIteratorUtils
    {
        ...
        {
           return vector.Reduce<T>(function, new T());
        }

        public static T Reduce<T>(this IEnumerable<T> vector, ReduceFunction<T> function, T initValue) where T : IEquatable<T>, new()
        {
    ...
    public class TemplateVector<T> : ICollection<T>, IEquatable<TemplateVector<T>>, ICloneable where T : IEquatable<T>, new()
    {
        ...
        public static T Reduce(IEnumerable<T> vector, ReduceFunction<T> function, T initValue) => vector.Reduce(function, initValue);
